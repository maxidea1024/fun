...
RowFormatter::RowFormatter( const String& prefix,
...
String& RowFormatter::FormatNames(const NameVecPtr names, String& formatted_names) {
...
String& RowFormatter::FormatValues(const ValueVec& /*vals*/, String& formatted_values) {
