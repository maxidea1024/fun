...
// defined with this macro as being exported.
    ...
    #define FUN_MYSQL_API  __declspec(dllexport)
  #else
    #define FUN_MYSQL_API  __declspec(dllimport)
  #endif
#endif

#if !defined(FUN_MYSQL_API)
  #if !defined(FUN_NO_GCC_API_ATTRIBUTE) && defined (__GNUC__) && (__GNUC__ >= 4)
    #define FUN_MYSQL_API  __attribute__((visibility("default")))
  #else
    #define FUN_MYSQL_API
  #endif
#endif

// Automatically link Data library.
#if defined(FUN_COMPILER_MSVC)
  #if !defined(FUN_NO_AUTOMATIC_LIBS) && !defined(FUN_MYSQL_EXPORTS)
    #pragma comment(lib, "fun-sql-mysql" FUN_LIB_SUFFIX)
  #endif
#endif
