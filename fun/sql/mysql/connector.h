...
class FUN_MYSQL_API Connector : public fun::sql::Connector {
 public:
  ...
  /**
   * Creates a MySQL SessionImpl object and initializes it with the given
   * connection_string.
   */
  virtual fun::RefCountedPtr<fun::sql::SessionImpl> CreateSession(
...
extern "C" const struct FUN_MYSQL_API MySqlConnectorRegistrator
    funMySqlConnectorRegistrator;
