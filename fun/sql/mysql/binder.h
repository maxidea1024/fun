...
class FUN_MYSQL_API Binder : public fun::sql::BinderBase {
 public:
  ...
  virtual void Bind(size_t pos, const int8& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const uint8& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const int16& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const uint16& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const int32& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const uint32& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const int64& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const uint64& val, Direction dir,
                    const WhenNullCb& null_cb);

#ifndef FUN_LONG_IS_64_BIT
  virtual void Bind(size_t pos, const long& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const unsigned long& val, Direction dir,
                    const WhenNullCb& null_cb);
#endif

  virtual void Bind(size_t pos, const bool& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const float& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const double& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const char& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const String& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const fun::sql::BLOB& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const fun::sql::CLOB& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const DateTime& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const Date& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const Time& val, Direction dir,
                    const WhenNullCb& null_cb);
  virtual void Bind(size_t pos, const NullData& val, Direction dir,
  ...
  virtual void Bind(size_t pos, const std::list<Time>& val,
                    Direction dir = PD_IN);
  virtual void Bind(size_t pos, const std::vector<NullData>& val, Direction dir,
                    const std::type_info& bind_type);
  virtual void Bind(size_t pos, const std::deque<NullData>& val, Direction dir,
                    const std::type_info& bind_type);
  virtual void Bind(size_t pos, const std::list<NullData>& val, Direction dir,
                    const std::type_info& bind_type);
 ...
 private:
   ...
   */
  void RealBind(size_t pos, enum_field_types type, const void* buffer,
                int length, bool is_unsigned = false);
