...
class FUN_SQL_API RowFilter : public WeakRefCountedObject {
 public:
  ...
  enum LogicOperator { OP_AND, OP_OR, OP_NOT };
   ...
   */
  template <typename T>
  void Add(const String& name, Comparison comparison, const T& value,
           LogicOperator op = OP_OR) {
    RewindRecordSet();
    comparison_map_.insert(ComparisonMap::value_type(
        toUpper(name), ComparisonEntry(value, comparison, op)));
  }
   ...
   */
  template <typename T>
  void Add(const String& name, const String& comp, const T& value,
           LogicOperator op = OP_OR) {
 ...
 private:
  ...
  static bool NotEqual(const fun::dynamic::Var& p1,
                       const fun::dynamic::Var& p2);
  ...
  static bool LessOrEqual(const fun::dynamic::Var& p1,
                          const fun::dynamic::Var& p2);
  static bool GreaterOrEqual(const fun::dynamic::Var& p1,
                             const fun::dynamic::Var& p2);
  static bool LogicalAnd(const fun::dynamic::Var& p1,
                         const fun::dynamic::Var& p2);
  static bool LogicalOr(const fun::dynamic::Var& p1,
                        const fun::dynamic::Var& p2);
  static bool IsNull(const fun::dynamic::Var& p1, const fun::dynamic::Var&);

  static void DoCompare(fun::dynamic::Var& ret, fun::dynamic::Var& val,
...
inline bool RowFilter::IsEmpty() const { return comparison_map_.size() == 0; }

inline bool RowFilter::Exists(const String& name) const {
  return comparison_map_.find(name) != comparison_map_.end();
}

inline void RowFilter::ToggleNot() { not_ = !not_; }

inline bool RowFilter::IsNot() const { return not_; }

inline bool RowFilter::Equal(const fun::dynamic::Var& p1,
                             const fun::dynamic::Var& p2) {
  return p1 == p2;
}

inline bool RowFilter::NotEqual(const fun::dynamic::Var& p1,
                                const fun::dynamic::Var& p2) {
  return p1 != p2;
}

inline bool RowFilter::Less(const fun::dynamic::Var& p1,
                            const fun::dynamic::Var& p2) {
  return p1 < p2;
}

inline bool RowFilter::Greater(const fun::dynamic::Var& p1,
                               const fun::dynamic::Var& p2) {
  return p1 > p2;
}

inline bool RowFilter::LessOrEqual(const fun::dynamic::Var& p1,
                                   const fun::dynamic::Var& p2) {
  return p1 <= p2;
}

inline bool RowFilter::GreaterOrEqual(const fun::dynamic::Var& p1,
                                      const fun::dynamic::Var& p2) {
  return p1 >= p2;
}

inline bool RowFilter::LogicalAnd(const fun::dynamic::Var& p1,
                                  const fun::dynamic::Var& p2) {
  return p1 && p2;
}

inline bool RowFilter::LogicalOr(const fun::dynamic::Var& p1,
                                 const fun::dynamic::Var& p2) {
  return p1 || p2;
}

inline bool RowFilter::IsNull(const fun::dynamic::Var& p1,
                              const fun::dynamic::Var&) {
  return p1.IsEmpty();
}
