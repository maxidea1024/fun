...
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, InvalidSQLStatementException, SQLiteException)
...
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, ExecutionAbortedException, SQLiteException)
...
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, ConstraintViolationException, SQLiteException)
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, DataTypeMismatchException, SQLiteException)
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, ParameterCountMismatchException, SQLiteException)
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, InvalidLibraryUseException, SQLiteException)
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, OSFeaturesMissingException, SQLiteException)
FUN_DECLARE_EXCEPTION(FUN_SQLITE_API, AuthorizationDeniedException, SQLiteException)
