...
WinRegistryConfiguration::WinRegistryConfiguration(const String& root_path, REGSAM extra_sam)
...
void WinRegistryConfiguration::RemoveRaw(const String& /*key*/) {
  throw fun::NotImplementedException("Removing a key in a WinRegistryConfiguration");
}

String WinRegistryConfiguration::ConvertToRegFormat(const String& key, String& value) const {
