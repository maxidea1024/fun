...
class FUN_BASE_API Timespan {
  ...
  */
  ...
  bool TryAssign(int32 days, int32 hours, int32 minutes, int32 seconds, int32 milliseconds, int32 microsecond);
  void Assign(int32 days, int32 hours, int32 minutes, int32 seconds, int32 milliseconds, int32 microsecond);
...
FUN_ALWAYS_INLINE Timespan::Timespan(int32 hours, int32 minutes, int32 seconds) {
  Assign(0, hours, minutes, seconds, 0, 0);
}

FUN_ALWAYS_INLINE Timespan::Timespan(int32 days, int32 hours, int32 minutes, int32 seconds) {
  Assign(days, hours, minutes, seconds, 0, 0);
}

FUN_ALWAYS_INLINE Timespan::Timespan(
    int32 days,
    int32 hours,
    int32 minutes,
    int32 seconds,
...
FUN_ALWAYS_INLINE int32 Timespan::Microseconds() const {
  return int32(((ticks_ % DateTimeConstants::TICKS_PER_MICROSECOND) / 1000) % 1000);
}
...
FUN_ALWAYS_INLINE int64 Timespan::ToTicks() const {
  return ticks_;
}
...
FUN_ALWAYS_INLINE Timespan operator "" h(unsigned long long value) { return Timespan::FromHours((double)value); }
FUN_ALWAYS_INLINE Timespan operator "" m(unsigned long long value) { return Timespan::FromMinutes((double)value); }
FUN_ALWAYS_INLINE Timespan operator "" s(unsigned long long value) { return Timespan::FromSeconds((double)value); }
FUN_ALWAYS_INLINE Timespan operator "" ms(unsigned long long value) { return Timespan::FromMilliseconds((double)value); }
FUN_ALWAYS_INLINE Timespan operator "" us(unsigned long long value) { return Timespan::FromMicroseconds((double)value); }
