...
class Delegate : public DelegateBase<ArgsType> {
 public:
  ...
  bool Equals(const DelegateBase<ArgsType>& other) const {
    const Delegate* other_delegate = dynamic_cast<const Delegate*>(other.Unwrap());
...
template <typename ObjectType, typename ArgsType>
FUN_ALWAYS_INLINE Delegate<ObjectType, ArgsType, true>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(const void*, ArgsType)) {
  return Delegate<ObjectType,ArgsType,true>(object, method);
}

template <typename ObjectType, typename ArgsType>
FUN_ALWAYS_INLINE Delegate<ObjectType, ArgsType, false>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(ArgsType)) {
  return Delegate<ObjectType,ArgsType,false>(object, method);
}

template <typename ObjectType, typename ArgsType>
FUN_ALWAYS_INLINE Expire<ArgsType>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(const void*, ArgsType), Timestamp::TimeDiff expire) {
  return Expire<ArgsType>(Delegate<ObjectType,ArgsType,true>(object, method), expire);
}

template <typename ObjectType, typename ArgsType>
FUN_ALWAYS_INLINE Expire<ArgsType>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(ArgsType), Timestamp::TimeDiff expire) {
  return Expire<ArgsType>(Delegate<ObjectType,ArgsType,false>(object, method), expire);
}

template <typename ArgsType>
FUN_ALWAYS_INLINE Expire<ArgsType>
MakeDelegate(void (*func)(const void*, ArgsType), Timestamp::TimeDiff expire) {
  return Expire<ArgsType>(FunctionDelegate<true,true>(func), expire);
}

template <typename ArgsType>
FUN_ALWAYS_INLINE Expire<ArgsType>
MakeDelegate(void (*func)(ArgsType), Timestamp::TimeDiff expire) {
...
template <typename ArgsType>
FUN_ALWAYS_INLINE FunctionDelegate<ArgsType, true, true>
MakeDelegate(void (*func)(const void*, ArgsType&)) {
  return FunctionDelegate<ArgsType, true, true>(func);
}

template <typename ArgsType>
FUN_ALWAYS_INLINE FunctionDelegate<ArgsType, true, false>
MakeDelegate(void (*func)(void*, ArgsType&)) {
  return FunctionDelegate<ArgsType, true, false>(func);
}

template <typename ArgsType>
FUN_ALWAYS_INLINE FunctionDelegate<ArgsType, false>
MakeDelegate(void (*func)(ArgsType&)) {
...
template <typename ObjectType>
FUN_ALWAYS_INLINE Delegate<ObjectType, void, true>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(const void*)) {
  return Delegate<ObjectType, void, true>(object, method);
}

template <typename ObjectType>
FUN_ALWAYS_INLINE Delegate<ObjectType, void, false>
MakeDelegate(ObjectType* object, void (ObjectType::*method)()) {
  return Delegate<ObjectType, void, false>(object, method);
}

template <typename ObjectType>
FUN_ALWAYS_INLINE Expire<void>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(const void*), Timestamp::TimeDiff expire) {
  return Expire<void>(Delegate<ObjectType, void, true>(object, method), expire);
}

template <typename ObjectType>
FUN_ALWAYS_INLINE Expire<void>
MakeDelegate(ObjectType* object, void (ObjectType::*method)(), Timestamp::TimeDiff expire) {
  return Expire<void>(Delegate<ObjectType, void, false>(object, method), expire);
}

FUN_ALWAYS_INLINE Expire<void> MakeDelegate(void (*func)(const void*), Timestamp::TimeDiff expire) {
  return Expire<void>(FunctionDelegate<void, true, true>(func), expire);
}

FUN_ALWAYS_INLINE Expire<void> MakeDelegate(void (*func)(void*), Timestamp::TimeDiff expire) {
  return Expire<void>(FunctionDelegate<void, true, false>(func), expire);
}

FUN_ALWAYS_INLINE Expire<void> MakeDelegate(void (*func)(), Timestamp::TimeDiff expire) {
  return Expire<void>(FunctionDelegate<void, false>(func), expire);
}

FUN_ALWAYS_INLINE FunctionDelegate<void, true, true> MakeDelegate(void (*func)(const void*)) {
  return FunctionDelegate<void, true, true>(func);
}

FUN_ALWAYS_INLINE FunctionDelegate<void, true, false> MakeDelegate(void (*func)(void*)) {
