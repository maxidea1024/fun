...
inline BackInsertIterator<Container> BackInserter(Container& container) {
...
template <typename Container>
inline FrontInsertIterator<Container> FrontInserter(Container& container) {
...
struct IteratorTraitsBase<
    It, Void_T<typename It::IteratorCategory, typename It::ValueType,
               typename It::DifferenceType, typename It::Pointer,
...
template <typename T>
    ...
    Void_T<typename IteratorCategoryOf<It>::Category> {
  enum { Value = true };
};
...
struct IsInputIterator {
  enum {
    Value = IsConvertible<typename IteratorCategoryOf<It>::Category,
                          InputIteator_TAG>::Value
  };
};
...
struct IsBidirectionalIterator {
  enum {
    Value = IsConvertible<typename IteratorCategoryOf<It>::Category,
                          BidirectionalIterator_TAG>::Value
  };
};
...
struct IsRandomAccessIterator {
  enum {
    Value = IsConvertible<typename IteratorCategoryOf<It>::Category,
                          RandomAccessIterator_TAG>::Value
  };
};
