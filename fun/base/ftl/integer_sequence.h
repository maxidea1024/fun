...
using MakeIntegerSequence =
    typename IntegerSequence_internal::MakeIntegerSequenceImpl<T, N>::Type;
...
struct ConcatImpl<N, IntegerSequence<T, Indices1...>,
                  IntegerSequence<T, Indices2...> >
    : IntegerSequence<T, Indices1..., (T(N + Indices2))...> {
...
template <typename T, size_t N>
struct MakeIntegerSequenceImpl : Concat<N / 2, MakeIntegerSequence<T, N / 2>,
                                        MakeIntegerSequence<T, N - N / 2> > {
  using Type = Concat<N / 2, MakeIntegerSequence<T, N / 2>,
                      MakeIntegerSequence<T, N - N / 2> >;
};
