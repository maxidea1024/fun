 ...
 */
FUN_BASE_API int32 FindSortedStringCaseInsensitive(const char* str, const char* const* sorted_array, int32 array_count);
...
FUN_ALWAYS_INLINE int32 FindSortedStringCaseInsensitive(const char* str, const char* const (&sorted_array)[array_count]) {
