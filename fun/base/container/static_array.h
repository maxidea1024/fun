...
class StaticArray
{
 public:
  ...
  {
    MoveConstructItems((void*)elements_, (const ElementType*)other.elements_, ElementCount);
  }
  ...
  {
    ConstructItems<ElementType>((void*)elements_, (const ElementType*)other.elements_, ElementCount);
  }
  ...
  {
    MoveAssignItems((ElementType*)elements_, (const ElementType*)other.elements_, ElementCount);
    return *this;
  }
  ...
  {
    CopyAssignItems((ElementType*)elements_, (const ElementType*)other.elements_, ElementCount);
    return *this;
  }
  ...
  ~StaticArray()
  {
    DestructItems((ElementType*)elements_, ElementCount);
  }
  ...
  ElementType* MutableData()
  {
    return (ElementType*)&elements_[0];
  }
...
StaticArray<ElementType, ElementCount>
MakeUniformStaticArray(typename CallTraits<ElementType>::ParamType value)
{
