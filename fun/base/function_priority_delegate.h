...
class FunctionPriorityDelegate : public PriorityDelegateBase<ArgsType> {
 public:
  ...
  bool Equals(const DelegateBase<ArgsType>& other) const {
    const FunctionPriorityDelegate* other_delegate =
        dynamic_cast<const FunctionPriorityDelegate*>(other.Unwrap());
    return other_delegate &&
           this->GetPriority() == other_delegate->GetPriority() &&
           function_ == other_delegate->function_;
  }
...
class FunctionPriorityDelegate<ArgsType, true, false>
    : public PriorityDelegateBase<ArgsType> {
 public:
...
template <typename ArgsType>
class FunctionPriorityDelegate<ArgsType, false>
    : public PriorityDelegateBase<ArgsType> {
 public:
 ...
 */
template <>
class FunctionPriorityDelegate<void, true, true>
    : public PriorityDelegateBase<void> {
 public:
...
template <>
class FunctionPriorityDelegate<void, true, false>
    : public PriorityDelegateBase<void> {
 public:
...
template <>
class FunctionPriorityDelegate<void, false>
    : public PriorityDelegateBase<void> {
 public:
