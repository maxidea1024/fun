...
int16 Variant::ToInt16() const {
  switch (type_) {
    ...
    case VariantTypes::Float:
      return (int16)Value<float>();
    case VariantTypes::Double:
      return (int16)Value<double>();
  }
  return 0;
}
...
uint16 Variant::ToUInt16() const {
  switch (type_) {
    ...
    case VariantTypes::Float:
      return (uint16)Value<float>();
    case VariantTypes::Double:
      return (uint16)Value<double>();
  }
  return 0;
}
...
int32 Variant::ToInt32() const {
  switch (type_) {
    ...
    case VariantTypes::Float:
      return (int32)Value<float>();
    case VariantTypes::Double:
      return (int32)Value<double>();
  }
  return 0;
}
...
uint32 Variant::ToUInt32() const {
  switch (type_) {
    ...
    case VariantTypes::Float:
      return (uint32)Value<float>();
    case VariantTypes::Double:
      return (uint32)Value<double>();
  }
  return 0;
}
...
bool Variant::ToBool() const { return ToInt16() != 0; }
