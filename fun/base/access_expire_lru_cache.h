...
>
class AccessExpireLruCache : public CacheBase<KeyType, ValueType, StrategyCollection<KeyType, ValueType>, MutexType, EventMutexType> {
 public:
  AccessExpireLruCache(size_t cache_size = 1024, Timestamp::TimeDiff expire = 600000)
