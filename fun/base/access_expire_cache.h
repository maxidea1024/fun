...
>
class AccessExpireCache : public CacheBase<KeyType, ValueType, AccessExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType> {
 public:
  AccessExpireCache(Timestamp::TimeDiff expire = 600000)
    : CacheBase<KeyType, ValueType, AccessExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType>(AccessExpireStrategy<KeyType, ValueType>(expire)) {}
