...
template <
  ...
  >
class UniqueAccessExpireLruCache : public CacheBase<KeyType, ValueType, UniqueAccessExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType> {
 public:
  UniqueAccessExpireLruCache(int32 cache_size = 1024)
    : CacheBase<KeyType, ValueType, UniqueAccessExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType>(UniqueAccessExpireStategy<KeyType, ValueType>()) {
  ...
  UniqueAccessExpireLruCache& operator = (const UniqueAccessExpireLruCache&) = delete;
};
