...
const char* Latin9Encoding::names_[] = {
  "ISO-8859-15",
  "Latin9",
  "Latin-9",
  nullptr
...
const char* Latin9Encoding::GetCanonicalName() const {
  return names_[0];
}
...
int32 Latin9Encoding::Convert(int32 ch, uint8* bytes, int32 len) const {
  if (ch >= 0 && ch <= 255 && char_map_[ch] == ch) {
    ...
    switch (ch) {
      case 0x0152: if (bytes && len >= 1) *bytes = 0xbc; return 1;
      case 0x0153: if (bytes && len >= 1) *bytes = 0xbd; return 1;
      case 0x0160: if (bytes && len >= 1) *bytes = 0xa6; return 1;
      case 0x0161: if (bytes && len >= 1) *bytes = 0xa8; return 1;
      case 0x017d: if (bytes && len >= 1) *bytes = 0xb4; return 1;
      case 0x017e: if (bytes && len >= 1) *bytes = 0xb8; return 1;
      case 0x0178: if (bytes && len >= 1) *bytes = 0xbe; return 1;
      case 0x20ac: if (bytes && len >= 1) *bytes = 0xa4; return 1;
      default: return 0;
    }
  }
}
...
int32 Latin9Encoding::SequenceLength(const uint8* /*bytes*/, int32 /*len*/) const {
  return 1;
}
