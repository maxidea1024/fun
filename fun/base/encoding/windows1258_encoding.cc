...
const char* Windows1258_Encoding::names_[] = {"windows-1258", "Windows-1258",
                                              "cp1258", "CP1258", nullptr};

const TextEncoding::CharacterMap Windows1258_Encoding::char_map_ = {
    ...
    0x007E, 0x007F, 0x20AC, -1,     0x201A, 0x0192, 0x201E, 0x2026, 0x2020,
    0x2021, 0x02C6, 0x2030, -1,     0x2039, 0x0152, -1,     -1,     -1,
    -1,     0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC,
    0x2122, -1,     0x203A, 0x0153, -1,     -1,     0x0178, 0x00A0, 0x00A1,
    0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA,
    0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00AF, 0x00B0, 0x00B1, 0x00B2, 0x00B3,
    0x00B4, 0x00B5, 0x00B6, 0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x00BC,
    0x00BD, 0x00BE, 0x00BF, 0x00C0, 0x00C1, 0x00C2, 0x0102, 0x00C4, 0x00C5,
    0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x0300, 0x00CD, 0x00CE,
    0x00CF, 0x0110, 0x00D1, 0x0309, 0x00D3, 0x00D4, 0x01A0, 0x00D6, 0x00D7,
    0x00D8, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x01AF, 0x0303, 0x00DF, 0x00E0,
    0x00E1, 0x00E2, 0x0103, 0x00E4, 0x00E5, 0x00E6, 0x00E7, 0x00E8, 0x00E9,
    0x00EA, 0x00EB, 0x0301, 0x00ED, 0x00EE, 0x00EF, 0x0111, 0x00F1, 0x0323,
    0x00F3, 0x00F4, 0x01A1, 0x00F6, 0x00F7, 0x00F8, 0x00F9, 0x00FA, 0x00FB,
    0x00FC, 0x01B0, 0x20AB, 0x00FF,
};

const DoubleByteEncoding::Mapping Windows1258_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    Windows1258_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00AC, 0x00AC}, {0x00AD, 0x00AD}, {0x00AE, 0x00AE}, {0x00AF, 0x00AF},
        ...
        {0x00C0, 0x00C0}, {0x00C1, 0x00C1}, {0x00C2, 0x00C2}, {0x00C4, 0x00C4},
        {0x00C5, 0x00C5}, {0x00C6, 0x00C6}, {0x00C7, 0x00C7}, {0x00C8, 0x00C8},
        {0x00C9, 0x00C9}, {0x00CA, 0x00CA}, {0x00CB, 0x00CB}, {0x00CD, 0x00CD},
        {0x00CE, 0x00CE}, {0x00CF, 0x00CF}, {0x00D1, 0x00D1}, {0x00D3, 0x00D3},
        {0x00D4, 0x00D4}, {0x00D6, 0x00D6}, {0x00D7, 0x00D7}, {0x00D8, 0x00D8},
        ...
        {0x00F8, 0x00F8}, {0x00F9, 0x00F9}, {0x00FA, 0x00FA}, {0x00FB, 0x00FB},
        {0x00FC, 0x00FC}, {0x00FF, 0x00FF}, {0x0102, 0x00C3}, {0x0103, 0x00E3},
        {0x0110, 0x00D0}, {0x0111, 0x00F0}, {0x0152, 0x008C}, {0x0153, 0x009C},
        {0x0178, 0x009F}, {0x0192, 0x0083}, {0x01A0, 0x00D5}, {0x01A1, 0x00F5},
        {0x01AF, 0x00DD}, {0x01B0, 0x00FD}, {0x02C6, 0x0088}, {0x02DC, 0x0098},
        {0x0300, 0x00CC}, {0x0301, 0x00EC}, {0x0303, 0x00DE}, {0x0309, 0x00D2},
        {0x0323, 0x00F2}, {0x2013, 0x0096}, {0x2014, 0x0097}, {0x2018, 0x0091},
        {0x2019, 0x0092}, {0x201A, 0x0082}, {0x201C, 0x0093}, {0x201D, 0x0094},
        {0x201E, 0x0084}, {0x2020, 0x0086}, {0x2021, 0x0087}, {0x2022, 0x0095},
        {0x2026, 0x0085}, {0x2030, 0x0089}, {0x2039, 0x008B}, {0x203A, 0x009B},
        {0x20AB, 0x00FE}, {0x20AC, 0x0080}, {0x2122, 0x0099},
};

Windows1258_Encoding::Windows1258_Encoding()
