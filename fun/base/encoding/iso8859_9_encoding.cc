...
const char* ISO8859_9_Encoding::names_[] = {"ISO-8859-9", "Latin5", "Latin-5",
                                            nullptr};

const TextEncoding::CharacterMap ISO8859_9_Encoding::char_map_ = {
...
const DoubleByteEncoding::Mapping ISO8859_9_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping ISO8859_9_Encoding::reverse_mapping_table_[] =
    {
        ...
        {0x0130, 0x00DD}, {0x0131, 0x00FD}, {0x015E, 0x00DE}, {0x015F, 0x00FE},
};

ISO8859_9_Encoding::ISO8859_9_Encoding()
