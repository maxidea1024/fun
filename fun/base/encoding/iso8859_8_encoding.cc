...
const char* ISO8859_8_Encoding::names_[] = {"ISO-8859-8", nullptr};

const TextEncoding::CharacterMap ISO8859_8_Encoding::char_map_ = {
...
const DoubleByteEncoding::Mapping ISO8859_8_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping ISO8859_8_Encoding::reverse_mapping_table_[] =
    {
        ...
        {0x00D7, 0x00AA}, {0x00F7, 0x00BA}, {0x05D0, 0x00E0}, {0x05D1, 0x00E1},
        {0x05D2, 0x00E2}, {0x05D3, 0x00E3}, {0x05D4, 0x00E4}, {0x05D5, 0x00E5},
        {0x05D6, 0x00E6}, {0x05D7, 0x00E7}, {0x05D8, 0x00E8}, {0x05D9, 0x00E9},
        {0x05DA, 0x00EA}, {0x05DB, 0x00EB}, {0x05DC, 0x00EC}, {0x05DD, 0x00ED},
        {0x05DE, 0x00EE}, {0x05DF, 0x00EF}, {0x05E0, 0x00F0}, {0x05E1, 0x00F1},
        {0x05E2, 0x00F2}, {0x05E3, 0x00F3}, {0x05E4, 0x00F4}, {0x05E5, 0x00F5},
        {0x05E6, 0x00F6}, {0x05E7, 0x00F7}, {0x05E8, 0x00F8}, {0x05E9, 0x00F9},
        {0x05EA, 0x00FA}, {0x200E, 0x00FD}, {0x200F, 0x00FE}, {0x2017, 0x00DF},
};

ISO8859_8_Encoding::ISO8859_8_Encoding()
