...
const char* ISO8859_13_Encoding::names_[] = {"ISO-8859-13", "Latin7", "Latin-7",
                                             nullptr};

const TextEncoding::CharacterMap ISO8859_13_Encoding::char_map_ = {
...
const DoubleByteEncoding::Mapping ISO8859_13_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    ISO8859_13_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00A6, 0x00A6}, {0x00A7, 0x00A7}, {0x00A9, 0x00A9}, {0x00AB, 0x00AB},
        {0x00AC, 0x00AC}, {0x00AD, 0x00AD}, {0x00AE, 0x00AE}, {0x00B0, 0x00B0},
        {0x00B1, 0x00B1}, {0x00B2, 0x00B2}, {0x00B3, 0x00B3}, {0x00B5, 0x00B5},
        {0x00B6, 0x00B6}, {0x00B7, 0x00B7}, {0x00B9, 0x00B9}, {0x00BB, 0x00BB},
        ...
        {0x2019, 0x00FF}, {0x201C, 0x00B4}, {0x201D, 0x00A1}, {0x201E, 0x00A5},
};

ISO8859_13_Encoding::ISO8859_13_Encoding()
