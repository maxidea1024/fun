...
const char* Windows1253_Encoding::names_[] = {"windows-1253", "Windows-1253",
                                              "cp1253", "CP1253", nullptr};

const TextEncoding::CharacterMap Windows1253_Encoding::char_map_ = {
    ...
    0x2021, -1,     0x2030, -1,     0x2039, -1,     -1,     -1,     -1,
    -1,     0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, -1,
    0x2122, -1,     0x203A, -1,     -1,     -1,     -1,     0x00A0, 0x0385,
    0x0386, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, -1,
    0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x2015, 0x00B0, 0x00B1, 0x00B2, 0x00B3,
    0x0384, 0x00B5, 0x00B6, 0x00B7, 0x0388, 0x0389, 0x038A, 0x00BB, 0x038C,
...
const DoubleByteEncoding::Mapping Windows1253_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    Windows1253_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00A0, 0x00A0}, {0x00A3, 0x00A3}, {0x00A4, 0x00A4}, {0x00A5, 0x00A5},
        ...
        {0x00BD, 0x00BD}, {0x0192, 0x0083}, {0x0384, 0x00B4}, {0x0385, 0x00A1},
        {0x0386, 0x00A2}, {0x0388, 0x00B8}, {0x0389, 0x00B9}, {0x038A, 0x00BA},
        {0x038C, 0x00BC}, {0x038E, 0x00BE}, {0x038F, 0x00BF}, {0x0390, 0x00C0},
        {0x0391, 0x00C1}, {0x0392, 0x00C2}, {0x0393, 0x00C3}, {0x0394, 0x00C4},
        {0x0395, 0x00C5}, {0x0396, 0x00C6}, {0x0397, 0x00C7}, {0x0398, 0x00C8},
        {0x0399, 0x00C9}, {0x039A, 0x00CA}, {0x039B, 0x00CB}, {0x039C, 0x00CC},
        {0x039D, 0x00CD}, {0x039E, 0x00CE}, {0x039F, 0x00CF}, {0x03A0, 0x00D0},
        {0x03A1, 0x00D1}, {0x03A3, 0x00D3}, {0x03A4, 0x00D4}, {0x03A5, 0x00D5},
        {0x03A6, 0x00D6}, {0x03A7, 0x00D7}, {0x03A8, 0x00D8}, {0x03A9, 0x00D9},
        {0x03AA, 0x00DA}, {0x03AB, 0x00DB}, {0x03AC, 0x00DC}, {0x03AD, 0x00DD},
        {0x03AE, 0x00DE}, {0x03AF, 0x00DF}, {0x03B0, 0x00E0}, {0x03B1, 0x00E1},
        {0x03B2, 0x00E2}, {0x03B3, 0x00E3}, {0x03B4, 0x00E4}, {0x03B5, 0x00E5},
        {0x03B6, 0x00E6}, {0x03B7, 0x00E7}, {0x03B8, 0x00E8}, {0x03B9, 0x00E9},
        {0x03BA, 0x00EA}, {0x03BB, 0x00EB}, {0x03BC, 0x00EC}, {0x03BD, 0x00ED},
        {0x03BE, 0x00EE}, {0x03BF, 0x00EF}, {0x03C0, 0x00F0}, {0x03C1, 0x00F1},
        {0x03C2, 0x00F2}, {0x03C3, 0x00F3}, {0x03C4, 0x00F4}, {0x03C5, 0x00F5},
        {0x03C6, 0x00F6}, {0x03C7, 0x00F7}, {0x03C8, 0x00F8}, {0x03C9, 0x00F9},
        {0x03CA, 0x00FA}, {0x03CB, 0x00FB}, {0x03CC, 0x00FC}, {0x03CD, 0x00FD},
        {0x03CE, 0x00FE}, {0x2013, 0x0096}, {0x2014, 0x0097}, {0x2015, 0x00AF},
        ...
        {0x203A, 0x009B}, {0x20AC, 0x0080}, {0x2122, 0x0099},
};

Windows1253_Encoding::Windows1253_Encoding()
