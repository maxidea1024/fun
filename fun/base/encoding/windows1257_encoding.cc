...
const char* Windows1257_Encoding::names_[] = {"windows-1257", "Windows-1257",
                                              "cp1257", "CP1257", nullptr};

const TextEncoding::CharacterMap Windows1257_Encoding::char_map_ = {
    ...
    0x007E, 0x007F, 0x20AC, -1,     0x201A, -1,     0x201E, 0x2026, 0x2020,
    0x2021, -1,     0x2030, -1,     0x2039, -1,     0x00A8, 0x02C7, 0x00B8,
    -1,     0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, -1,
    0x2122, -1,     0x203A, -1,     0x00AF, 0x02DB, -1,     0x00A0, -1,
    0x00A2, 0x00A3, 0x00A4, -1,     0x00A6, 0x00A7, 0x00D8, 0x00A9, 0x0156,
...
const DoubleByteEncoding::Mapping Windows1257_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    Windows1257_Encoding::reverse_mapping_table_[] = {
...
Windows1257_Encoding::Windows1257_Encoding()
