...
const char* Windows1252Encoding::names_[] = {
  "windows-1252",
  "Windows-1252",
  "cp1252",
  "CP1252",
...
const TextEncoding::CharacterMap Windows1252Encoding::char_map_ = {
...
const char* Windows1252Encoding::GetCanonicalName() const {
  return names_[0];
}

bool Windows1252Encoding::IsA(const String& encoding_name) const {
...
const TextEncoding::CharacterMap& Windows1252Encoding::GetCharacterMap() const {
  return char_map_;
}

int32 Windows1252Encoding::Convert(const uint8* bytes) const {
  return char_map_[*bytes];
}

int32 Windows1252Encoding::Convert(int32 ch, uint8* bytes, int32 len) const {
  if (ch >= 0 && ch <= 255 && char_map_[ch] == ch) {
    ...
    switch (ch) {
      ...
      case 0x0192: if (bytes && len >= 1) *bytes = 0x83; return 1;
      ...
      case 0x02c6: if (bytes && len >= 1) *bytes = 0x88; return 1;
      ...
      case 0x0152: if (bytes && len >= 1) *bytes = 0x8c; return 1;
      ...
      case 0x02dc: if (bytes && len >= 1) *bytes = 0x98; return 1;
      ...
      case 0x0153: if (bytes && len >= 1) *bytes = 0x9c; return 1;
      case 0x017e: if (bytes && len >= 1) *bytes = 0x9e; return 1;
      case 0x0178: if (bytes && len >= 1) *bytes = 0x9f; return 1;
      default: return 0;
    }
  }
}

int32 Windows1252Encoding::QueryConvert(const uint8* bytes, int32 len) const {
  if (1 <= len) {
    return char_map_[*bytes];
  } else {
    return -1;
...
int32 Windows1252Encoding::SequenceLength(const uint8* /*bytes*/, int32 /*len*/) const {
  return 1;
}
