...
const char* Latin1Encoding::names_[] = {
  "ISO-8859-1",
  "Latin1",
  "Latin-1",
  nullptr
...
const char* Latin1Encoding::GetCanonicalName() const {
  return names_[0];
}
...
int32 Latin1Encoding::Convert(const uint8* bytes) const {
  return *bytes;
}
...
int32 Latin1Encoding::SequenceLength(const uint8* /*bytes*/, int32 /*len*/) const {
  return 1;
}
