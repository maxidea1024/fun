...
const char* Windows1254_Encoding::names_[] = {"windows-1254", "Windows-1254",
                                              "cp1254", "CP1254", nullptr};

const TextEncoding::CharacterMap Windows1254_Encoding::char_map_ = {
    ...
    0x2021, 0x02C6, 0x2030, 0x0160, 0x2039, 0x0152, -1,     -1,     -1,
    -1,     0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC,
    0x2122, 0x0161, 0x203A, 0x0153, -1,     -1,     0x0178, 0x00A0, 0x00A1,
...
const DoubleByteEncoding::Mapping Windows1254_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    Windows1254_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00C0, 0x00C0}, {0x00C1, 0x00C1}, {0x00C2, 0x00C2}, {0x00C3, 0x00C3},
        ...
        {0x00EF, 0x00EF}, {0x00F1, 0x00F1}, {0x00F2, 0x00F2}, {0x00F3, 0x00F3},
        {0x00F4, 0x00F4}, {0x00F5, 0x00F5}, {0x00F6, 0x00F6}, {0x00F7, 0x00F7},
        {0x00F8, 0x00F8}, {0x00F9, 0x00F9}, {0x00FA, 0x00FA}, {0x00FB, 0x00FB},
        {0x00FC, 0x00FC}, {0x00FF, 0x00FF}, {0x011E, 0x00D0}, {0x011F, 0x00F0},
        {0x0130, 0x00DD}, {0x0131, 0x00FD}, {0x0152, 0x008C}, {0x0153, 0x009C},
        {0x015E, 0x00DE}, {0x015F, 0x00FE}, {0x0160, 0x008A}, {0x0161, 0x009A},
        {0x0178, 0x009F}, {0x0192, 0x0083}, {0x02C6, 0x0088}, {0x02DC, 0x0098},
        {0x2013, 0x0096}, {0x2014, 0x0097}, {0x2018, 0x0091}, {0x2019, 0x0092},
        {0x201A, 0x0082}, {0x201C, 0x0093}, {0x201D, 0x0094}, {0x201E, 0x0084},
        {0x2020, 0x0086}, {0x2021, 0x0087}, {0x2022, 0x0095}, {0x2026, 0x0085},
        {0x2030, 0x0089}, {0x2039, 0x008B}, {0x203A, 0x009B}, {0x20AC, 0x0080},
        {0x2122, 0x0099},
};

Windows1254_Encoding::Windows1254_Encoding()
