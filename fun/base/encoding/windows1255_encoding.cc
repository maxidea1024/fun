...
const char* Windows1255_Encoding::names_[] = {"windows-1255", "Windows-1255",
                                              "cp1255", "CP1255", nullptr};

const TextEncoding::CharacterMap Windows1255_Encoding::char_map_ = {
    ...
    0x2021, 0x02C6, 0x2030, -1,     0x2039, -1,     -1,     -1,     -1,
    -1,     0x2018, 0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC,
    0x2122, -1,     0x203A, -1,     -1,     -1,     -1,     0x00A0, 0x00A1,
    0x00A2, 0x00A3, 0x20AA, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00D7,
    0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00AF, 0x00B0, 0x00B1, 0x00B2, 0x00B3,
    0x00B4, 0x00B5, 0x00B6, 0x00B7, 0x00B8, 0x00B9, 0x00F7, 0x00BB, 0x00BC,
    0x00BD, 0x00BE, 0x00BF, 0x05B0, 0x05B1, 0x05B2, 0x05B3, 0x05B4, 0x05B5,
    0x05B6, 0x05B7, 0x05B8, 0x05B9, -1,     0x05BB, 0x05BC, 0x05BD, 0x05BE,
    0x05BF, 0x05C0, 0x05C1, 0x05C2, 0x05C3, 0x05F0, 0x05F1, 0x05F2, 0x05F3,
    0x05F4, -1,     -1,     -1,     -1,     -1,     -1,     -1,     0x05D0,
...
const DoubleByteEncoding::Mapping Windows1255_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    Windows1255_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00BF, 0x00BF}, {0x00D7, 0x00AA}, {0x00F7, 0x00BA}, {0x0192, 0x0083},
        {0x02C6, 0x0088}, {0x02DC, 0x0098}, {0x05B0, 0x00C0}, {0x05B1, 0x00C1},
        {0x05B2, 0x00C2}, {0x05B3, 0x00C3}, {0x05B4, 0x00C4}, {0x05B5, 0x00C5},
        {0x05B6, 0x00C6}, {0x05B7, 0x00C7}, {0x05B8, 0x00C8}, {0x05B9, 0x00C9},
        {0x05BB, 0x00CB}, {0x05BC, 0x00CC}, {0x05BD, 0x00CD}, {0x05BE, 0x00CE},
        {0x05BF, 0x00CF}, {0x05C0, 0x00D0}, {0x05C1, 0x00D1}, {0x05C2, 0x00D2},
        {0x05C3, 0x00D3}, {0x05D0, 0x00E0}, {0x05D1, 0x00E1}, {0x05D2, 0x00E2},
        {0x05D3, 0x00E3}, {0x05D4, 0x00E4}, {0x05D5, 0x00E5}, {0x05D6, 0x00E6},
        {0x05D7, 0x00E7}, {0x05D8, 0x00E8}, {0x05D9, 0x00E9}, {0x05DA, 0x00EA},
        {0x05DB, 0x00EB}, {0x05DC, 0x00EC}, {0x05DD, 0x00ED}, {0x05DE, 0x00EE},
        {0x05DF, 0x00EF}, {0x05E0, 0x00F0}, {0x05E1, 0x00F1}, {0x05E2, 0x00F2},
        {0x05E3, 0x00F3}, {0x05E4, 0x00F4}, {0x05E5, 0x00F5}, {0x05E6, 0x00F6},
        {0x05E7, 0x00F7}, {0x05E8, 0x00F8}, {0x05E9, 0x00F9}, {0x05EA, 0x00FA},
        {0x05F0, 0x00D4}, {0x05F1, 0x00D5}, {0x05F2, 0x00D6}, {0x05F3, 0x00D7},
        {0x05F4, 0x00D8}, {0x200E, 0x00FD}, {0x200F, 0x00FE}, {0x2013, 0x0096},
        ...
        {0x2039, 0x008B}, {0x203A, 0x009B}, {0x20AA, 0x00A4}, {0x20AC, 0x0080},
        {0x2122, 0x0099},
};

Windows1255_Encoding::Windows1255_Encoding()
