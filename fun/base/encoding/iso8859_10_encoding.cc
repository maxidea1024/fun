...
const char* ISO8859_10_Encoding::names_[] = {"ISO-8859-10", "Latin6", "Latin-6",
                                             nullptr};

const TextEncoding::CharacterMap ISO8859_10_Encoding::char_map_ = {
    ...
    0x012B, 0x0129, 0x0137, 0x00B7, 0x013C, 0x0111, 0x0161, 0x0167, 0x017E,
    0x2015, 0x016B, 0x014B, 0x0100, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5,
...
const DoubleByteEncoding::Mapping ISO8859_10_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    ISO8859_10_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00A0, 0x00A0}, {0x00A7, 0x00A7}, {0x00AD, 0x00AD}, {0x00B0, 0x00B0},
        {0x00B7, 0x00B7}, {0x00C1, 0x00C1}, {0x00C2, 0x00C2}, {0x00C3, 0x00C3},
        {0x00C4, 0x00C4}, {0x00C5, 0x00C5}, {0x00C6, 0x00C6}, {0x00C9, 0x00C9},
        {0x00CB, 0x00CB}, {0x00CD, 0x00CD}, {0x00CE, 0x00CE}, {0x00CF, 0x00CF},
        {0x00D0, 0x00D0}, {0x00D3, 0x00D3}, {0x00D4, 0x00D4}, {0x00D5, 0x00D5},
        {0x00D6, 0x00D6}, {0x00D8, 0x00D8}, {0x00DA, 0x00DA}, {0x00DB, 0x00DB},
        {0x00DC, 0x00DC}, {0x00DD, 0x00DD}, {0x00DE, 0x00DE}, {0x00DF, 0x00DF},
        {0x00E1, 0x00E1}, {0x00E2, 0x00E2}, {0x00E3, 0x00E3}, {0x00E4, 0x00E4},
        {0x00E5, 0x00E5}, {0x00E6, 0x00E6}, {0x00E9, 0x00E9}, {0x00EB, 0x00EB},
        {0x00ED, 0x00ED}, {0x00EE, 0x00EE}, {0x00EF, 0x00EF}, {0x00F0, 0x00F0},
        {0x00F3, 0x00F3}, {0x00F4, 0x00F4}, {0x00F5, 0x00F5}, {0x00F6, 0x00F6},
        {0x00F8, 0x00F8}, {0x00FA, 0x00FA}, {0x00FB, 0x00FB}, {0x00FC, 0x00FC},
        {0x00FD, 0x00FD}, {0x00FE, 0x00FE}, {0x0100, 0x00C0}, {0x0101, 0x00E0},
        {0x0104, 0x00A1}, {0x0105, 0x00B1}, {0x010C, 0x00C8}, {0x010D, 0x00E8},
        {0x0110, 0x00A9}, {0x0111, 0x00B9}, {0x0112, 0x00A2}, {0x0113, 0x00B2},
        {0x0116, 0x00CC}, {0x0117, 0x00EC}, {0x0118, 0x00CA}, {0x0119, 0x00EA},
        {0x0122, 0x00A3}, {0x0123, 0x00B3}, {0x0128, 0x00A5}, {0x0129, 0x00B5},
        {0x012A, 0x00A4}, {0x012B, 0x00B4}, {0x012E, 0x00C7}, {0x012F, 0x00E7},
        {0x0136, 0x00A6}, {0x0137, 0x00B6}, {0x0138, 0x00FF}, {0x013B, 0x00A8},
        {0x013C, 0x00B8}, {0x0145, 0x00D1}, {0x0146, 0x00F1}, {0x014A, 0x00AF},
        {0x014B, 0x00BF}, {0x014C, 0x00D2}, {0x014D, 0x00F2}, {0x0160, 0x00AA},
        {0x0161, 0x00BA}, {0x0166, 0x00AB}, {0x0167, 0x00BB}, {0x0168, 0x00D7},
        {0x0169, 0x00F7}, {0x016A, 0x00AE}, {0x016B, 0x00BE}, {0x0172, 0x00D9},
        {0x0173, 0x00F9}, {0x017D, 0x00AC}, {0x017E, 0x00BC}, {0x2015, 0x00BD},
};

ISO8859_10_Encoding::ISO8859_10_Encoding()
