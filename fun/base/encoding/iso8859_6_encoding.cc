...
const char* ISO8859_6_Encoding::names_[] = {"ISO-8859-6", nullptr};

const TextEncoding::CharacterMap ISO8859_6_Encoding::char_map_ = {
    ...
    0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F, 0x00A0, -1,
...
const DoubleByteEncoding::Mapping ISO8859_6_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping ISO8859_6_Encoding::reverse_mapping_table_[] =
    {
        ...
        {0x00A0, 0x00A0}, {0x00A4, 0x00A4}, {0x00AD, 0x00AD}, {0x060C, 0x00AC},
        {0x061B, 0x00BB}, {0x061F, 0x00BF}, {0x0621, 0x00C1}, {0x0622, 0x00C2},
        ...
        {0x0637, 0x00D7}, {0x0638, 0x00D8}, {0x0639, 0x00D9}, {0x063A, 0x00DA},
        {0x0640, 0x00E0}, {0x0641, 0x00E1}, {0x0642, 0x00E2}, {0x0643, 0x00E3},
        {0x0644, 0x00E4}, {0x0645, 0x00E5}, {0x0646, 0x00E6}, {0x0647, 0x00E7},
        {0x0648, 0x00E8}, {0x0649, 0x00E9}, {0x064A, 0x00EA}, {0x064B, 0x00EB},
        {0x064C, 0x00EC}, {0x064D, 0x00ED}, {0x064E, 0x00EE}, {0x064F, 0x00EF},
        {0x0650, 0x00F0}, {0x0651, 0x00F1}, {0x0652, 0x00F2},
};

ISO8859_6_Encoding::ISO8859_6_Encoding()
