...
const char* ISO8859_5_Encoding::names_[] = {"ISO-8859-5", nullptr};

const TextEncoding::CharacterMap ISO8859_5_Encoding::char_map_ = {
...
const DoubleByteEncoding::Mapping ISO8859_5_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping ISO8859_5_Encoding::reverse_mapping_table_[] =
    {
        ...
        {0x00A0, 0x00A0}, {0x00A7, 0x00FD}, {0x00AD, 0x00AD}, {0x0401, 0x00A1},
        {0x0402, 0x00A2}, {0x0403, 0x00A3}, {0x0404, 0x00A4}, {0x0405, 0x00A5},
        {0x0406, 0x00A6}, {0x0407, 0x00A7}, {0x0408, 0x00A8}, {0x0409, 0x00A9},
        {0x040A, 0x00AA}, {0x040B, 0x00AB}, {0x040C, 0x00AC}, {0x040E, 0x00AE},
        {0x040F, 0x00AF}, {0x0410, 0x00B0}, {0x0411, 0x00B1}, {0x0412, 0x00B2},
        {0x0413, 0x00B3}, {0x0414, 0x00B4}, {0x0415, 0x00B5}, {0x0416, 0x00B6},
        {0x0417, 0x00B7}, {0x0418, 0x00B8}, {0x0419, 0x00B9}, {0x041A, 0x00BA},
        {0x041B, 0x00BB}, {0x041C, 0x00BC}, {0x041D, 0x00BD}, {0x041E, 0x00BE},
        {0x041F, 0x00BF}, {0x0420, 0x00C0}, {0x0421, 0x00C1}, {0x0422, 0x00C2},
        {0x0423, 0x00C3}, {0x0424, 0x00C4}, {0x0425, 0x00C5}, {0x0426, 0x00C6},
        {0x0427, 0x00C7}, {0x0428, 0x00C8}, {0x0429, 0x00C9}, {0x042A, 0x00CA},
        {0x042B, 0x00CB}, {0x042C, 0x00CC}, {0x042D, 0x00CD}, {0x042E, 0x00CE},
        {0x042F, 0x00CF}, {0x0430, 0x00D0}, {0x0431, 0x00D1}, {0x0432, 0x00D2},
        {0x0433, 0x00D3}, {0x0434, 0x00D4}, {0x0435, 0x00D5}, {0x0436, 0x00D6},
        {0x0437, 0x00D7}, {0x0438, 0x00D8}, {0x0439, 0x00D9}, {0x043A, 0x00DA},
        {0x043B, 0x00DB}, {0x043C, 0x00DC}, {0x043D, 0x00DD}, {0x043E, 0x00DE},
        {0x043F, 0x00DF}, {0x0440, 0x00E0}, {0x0441, 0x00E1}, {0x0442, 0x00E2},
        {0x0443, 0x00E3}, {0x0444, 0x00E4}, {0x0445, 0x00E5}, {0x0446, 0x00E6},
        {0x0447, 0x00E7}, {0x0448, 0x00E8}, {0x0449, 0x00E9}, {0x044A, 0x00EA},
        {0x044B, 0x00EB}, {0x044C, 0x00EC}, {0x044D, 0x00ED}, {0x044E, 0x00EE},
        {0x044F, 0x00EF}, {0x0451, 0x00F1}, {0x0452, 0x00F2}, {0x0453, 0x00F3},
        {0x0454, 0x00F4}, {0x0455, 0x00F5}, {0x0456, 0x00F6}, {0x0457, 0x00F7},
        {0x0458, 0x00F8}, {0x0459, 0x00F9}, {0x045A, 0x00FA}, {0x045B, 0x00FB},
        {0x045C, 0x00FC}, {0x045E, 0x00FE}, {0x045F, 0x00FF}, {0x2116, 0x00F0},
};

ISO8859_5_Encoding::ISO8859_5_Encoding()
