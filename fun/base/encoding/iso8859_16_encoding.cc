...
const char* ISO8859_16_Encoding::names_[] = {"ISO-8859-16", "Latin10",
                                             "Latin-10", nullptr};

const TextEncoding::CharacterMap ISO8859_16_Encoding::char_map_ = {
    ...
    0x0105, 0x0141, 0x20AC, 0x201E, 0x0160, 0x00A7, 0x0161, 0x00A9, 0x0218,
    0x00AB, 0x0179, 0x00AD, 0x017A, 0x017B, 0x00B0, 0x00B1, 0x010C, 0x0142,
    0x017D, 0x201D, 0x00B6, 0x00B7, 0x017E, 0x010D, 0x0219, 0x00BB, 0x0152,
    0x0153, 0x0178, 0x017C, 0x00C0, 0x00C1, 0x00C2, 0x0102, 0x00C4, 0x0106,
    0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE,
    0x00CF, 0x0110, 0x0143, 0x00D2, 0x00D3, 0x00D4, 0x0150, 0x00D6, 0x015A,
    0x0170, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x0118, 0x021A, 0x00DF, 0x00E0,
    0x00E1, 0x00E2, 0x0103, 0x00E4, 0x0107, 0x00E6, 0x00E7, 0x00E8, 0x00E9,
    0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF, 0x0111, 0x0144, 0x00F2,
    0x00F3, 0x00F4, 0x0151, 0x00F6, 0x015B, 0x0171, 0x00F9, 0x00FA, 0x00FB,
    0x00FC, 0x0119, 0x021B, 0x00FF,
};

const DoubleByteEncoding::Mapping ISO8859_16_Encoding::mapping_table_[] = {
    {0x0000, 0x0000}  // dummy entry
};

const DoubleByteEncoding::Mapping
    ISO8859_16_Encoding::reverse_mapping_table_[] = {
        ...
        {0x00AD, 0x00AD}, {0x00B0, 0x00B0}, {0x00B1, 0x00B1}, {0x00B6, 0x00B6},
        {0x00B7, 0x00B7}, {0x00BB, 0x00BB}, {0x00C0, 0x00C0}, {0x00C1, 0x00C1},
        {0x00C2, 0x00C2}, {0x00C4, 0x00C4}, {0x00C6, 0x00C6}, {0x00C7, 0x00C7},
        ...
        {0x00E4, 0x00E4}, {0x00E6, 0x00E6}, {0x00E7, 0x00E7}, {0x00E8, 0x00E8},
        {0x00E9, 0x00E9}, {0x00EA, 0x00EA}, {0x00EB, 0x00EB}, {0x00EC, 0x00EC},
        {0x00ED, 0x00ED}, {0x00EE, 0x00EE}, {0x00EF, 0x00EF}, {0x00F2, 0x00F2},
        {0x00F3, 0x00F3}, {0x00F4, 0x00F4}, {0x00F6, 0x00F6}, {0x00F9, 0x00F9},
        {0x00FA, 0x00FA}, {0x00FB, 0x00FB}, {0x00FC, 0x00FC}, {0x00FF, 0x00FF},
        {0x0102, 0x00C3}, {0x0103, 0x00E3}, {0x0104, 0x00A1}, {0x0105, 0x00A2},
        {0x0106, 0x00C5}, {0x0107, 0x00E5}, {0x010C, 0x00B2}, {0x010D, 0x00B9},
        {0x0110, 0x00D0}, {0x0111, 0x00F0}, {0x0118, 0x00DD}, {0x0119, 0x00FD},
        {0x0141, 0x00A3}, {0x0142, 0x00B3}, {0x0143, 0x00D1}, {0x0144, 0x00F1},
        {0x0150, 0x00D5}, {0x0151, 0x00F5}, {0x0152, 0x00BC}, {0x0153, 0x00BD},
        {0x015A, 0x00D7}, {0x015B, 0x00F7}, {0x0160, 0x00A6}, {0x0161, 0x00A8},
        {0x0170, 0x00D8}, {0x0171, 0x00F8}, {0x0178, 0x00BE}, {0x0179, 0x00AC},
        {0x017A, 0x00AE}, {0x017B, 0x00AF}, {0x017C, 0x00BF}, {0x017D, 0x00B4},
        {0x017E, 0x00B8}, {0x0218, 0x00AA}, {0x0219, 0x00BA}, {0x021A, 0x00DE},
        {0x021B, 0x00FE}, {0x201D, 0x00B5}, {0x201E, 0x00A5}, {0x20AC, 0x00A4},
};

ISO8859_16_Encoding::ISO8859_16_Encoding()
