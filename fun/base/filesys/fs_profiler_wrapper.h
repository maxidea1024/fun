...
class ProfiledFSStatsFileBase : public ProfiledFSStatsBase {
 public:
  ...
  ProfiledFSStatsFileBase(const char* filename)
    : name_(filename) {}
};
...
class ProfiledFSStatsFileSimple : public ProfiledFSStatsFileBase {
 public:
  ProfiledFSStatsFileSimple(const char* filename)
    : ProfiledFSStatsFileBase(filename) {
    for (uint8 type_index = 0; type_index < (uint8)ProfiledFSStatsOp::OpType::Count; ++type_index) {
      SharedPtr<ProfiledFSStatsOp> stat(new ProfiledFSStatsOp(ProfiledFSStatsOp::OpType(type_index)));
      children_.Add(stat);
    }
  }
...
class ProfiledFile : public IFile {
 public:
  ...
  int64 Tell() override {
    ProfiledFSStatsOp* stat(file_stats_->CreateOpStat(ProfiledFSStatsOp::OpType::Tell));
  ...
  bool Seek(int64 new_pos) override {
    ProfiledFSStatsOp* stat(file_stats_->CreateOpStat(ProfiledFSStatsOp::OpType::Seek));
  ...
  bool Read(uint8* dst, int64 len_to_read) override {
    ProfiledFSStatsOp* stat(file_stats_->CreateOpStat(ProfiledFSStatsOp::OpType::Read));
  ...
  bool Write(const uint8* src, int64 len_to_write) override {
    ProfiledFSStatsOp* stat(file_stats_->CreateOpStat(ProfiledFSStatsOp::OpType::Write));
  ...
  int64 Size() override {
    ProfiledFSStatsOp* stat(file_stats_->CreateOpStat(ProfiledFSStatsOp::OpType::Size));
...
class FUN_BASE_API ProfiledPlatformFileSystem : public IPlatformFS {
 ...
 protected:
  ...
  ProfiledPlatformFileSystem()
    : lower_level_(nullptr), start_time_(0.0) {}
};
...
class TypedProfiledPlatformFileSystem : public ProfiledPlatformFileSystem {
 public:
  ...
  bool FileExists(const char* filename) override {
    ...
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Exists);
  ...
  int64 FileSize(const char* filename) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Size);
  ...
  bool DeleteFile(const char* filename) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Delete);
  ...
  bool IsReadOnly(const char* filename) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::IsReadOnly);
  ...
  bool MoveFile(const char* to, const char* from) override {
    ...
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Move);
  ...
  bool SetReadOnly(const char* filename, bool readonly) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::SetReadOnly);
  ...
  DateTime GetTimestamp(const char* filename) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::GetTimestamp);
  ...
  void SetTimestamp(const char* filename, const DateTime& timestamp) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::SetTimestamp);
    double op_start_time = SystemTime::Seconds();
  ...
  String GetFilenameOnDisk(const char* filename) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::GetFilenameOnDisk);
    double op_start_time = SystemTime::Seconds();
  ...
  IFile* OpenRead(const char* filename, bool allow_write = false) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::OpenRead);
    IFile* result = lower_level_->OpenRead(filename, allow_write);
    op_stat->duration += SystemTime::Seconds() * 1000.0 - op_stat->last_op_time;
    return result ? (new ProfiledFile<StatsType>(result, filename, file_stat)) : result;
  }

  IFile* OpenWrite(const char* filename, bool append = false, bool allow_read = false) override {
    StatsType* file_stat = CreateStat(filename);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::OpenWrite);
  ...
  bool CreateDirectory(const char* directory) override {
    StatsType* file_stat = CreateStat(directory);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Create);
  ...
  FileStatData GetStatData(const char* filename_or_directory) override {
    ...
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::GetStatData);
  ...
  bool IterateDirectory(const char* directory, IPlatformFS::DirectoryVisitor& visitor) override {
    StatsType* file_stat = CreateStat(directory);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Iterate);
  ...
  bool IterateDirectoryStat(const char* directory, IPlatformFS::DirectoryStatVisitor& visitor) override {
    StatsType* file_stat = CreateStat(directory);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::IterateStat);
  ...
  bool IterateDirectoryStatRecursively(const char* directory, IPlatformFS::DirectoryStatVisitor& visitor) override {
    StatsType* file_stat = CreateStat(directory);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::IterateStat);
    bool result = lower_level_->IterateDirectoryStatRecursively(directory, visitor);
    op_stat->duration += SystemTime::Seconds() * 1000.0 - op_stat->last_op_time;
    return result;
  }
  ...
  bool CopyFile(const char* to, const char* from) override {
    StatsType* file_stat = CreateStat(from);
    ProfiledFSStatsOp* op_stat = file_stat->CreateOpStat(ProfiledFSStatsOp::OpType::Copy);
...
template <>
inline const char* TypedProfiledPlatformFileSystem<ProfiledFSStatsFileDetailed>::GetTypeName() {
  return "ProfileFile";
}

template <>
inline const char* TypedProfiledPlatformFileSystem<ProfiledFSStatsFileSimple>::GetTypeName() {
...
class PlatformFSReadStatsHandle : public IFile {
 public:
  PlatformFSReadStatsHandle(IFile* file,
                            const char* filename,
...
class FUN_BASE_API PlatformFSReadStats : public IPlatformFS {
 public:
  PlatformFSReadStats()
    : lower_level_(nullptr), timer_(0.f) {}
  ...
  IFile* OpenRead(const char* filename, bool allow_write) override {
    IFile* result = lower_level_->OpenRead(filename, allow_write);
    return result ? (new PlatformFSReadStatsHandle(result, filename, &bytes_per_sec_this_tick_, &bytes_read_this_tick_, &reads_this_tick_)) : result;
  }
 ...
 protected:
  IPlatformFS* lower_level_;
  double lifetime_read_speed_; // Total maintained over lifetime of runtime, in KB per sec
  double lifetime_read_size_; // Total maintained over lifetime of runtime, in bytes
