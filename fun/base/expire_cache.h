 ...
 * period use a fun::AccessExpireCache.
 *
...
>
class ExpireCache : public CacheBase<KeyType, ValueType, ExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType> {
 public:
  ExpireCache(Timestamp::TimeDiff expire = 600000)
    : CacheBase<KeyType, ValueType, ExpireStrategy<KeyType, ValueType>, MutexType, EventMutexType>(ExpireStrategy<KeyType, ValueType>(expire)) {}
