...
inline ByteString ToString(const Map<KeyType,ValueType,SetAllocator,KeyFuncs>& map) {
  ByteString result;
  result += "{";
  bool first = true;
...
template <typename KeyType, typename ValueType, typename SetAllocator, typename KeyFuncs>
inline ByteString ToString(const MultiMap<KeyType,ValueType,SetAllocator,KeyFuncs>& multi_map) {
  ByteString result;
  result += "{";
  bool first = true;
