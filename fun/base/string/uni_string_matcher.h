...
class UStringMatcher {
 public:
  UStringMatcher();
  UStringMatcher(UStringView pattern, CaseSensitivity casesense = CaseSensitivity::CaseSensitive);
  ~UStringMatcher();
 ...
 public:
  ...
  static int32 FastFind(const UNICHAR* haystack,
                        int32 haystack_len,
                        int32 from,
  ...
  static int32 FastLastFind(const UNICHAR* haystack,
                            int32 haystack_len,
                            int32 from,
                            const UNICHAR* needle,
                            int32 needle_len,
  ...
  static int32 FastFindChar(const UNICHAR* str,
                            int32 length,
                            UNICHAR ch,
                            int32 from,
                            CaseSensitivity casesense);
                            
  static int32 FastLastFindChar(const UNICHAR* str,
                                int32 length,
                                UNICHAR ch,
                                int32 from,
                                CaseSensitivity casesense);
