...
struct SelectLiteral<UNICHAR> {
  static const UNICHAR  Select(const char  ansi, const UNICHAR  uni) { return uni; }
  static const UNICHAR* Select(const char* ansi, const UNICHAR* uni) { return uni; }
};
...
struct CharTraits : public CharTraitsBase<T, sizeof(T)> {
   ...
   */
  static FUN_ALWAYS_INLINE CharType IntToDigitChar(int32 n, CharType def = '?') {
   ...
   */
  static FUN_ALWAYS_INLINE CharType NibbleToHexChar(uint8 n, CharType def = '?') {
    return (n < 16) ? ('a' + n) : def;
  }
};
...
template <> FUN_ALWAYS_INLINE CharTraits<UNICHAR>::CharType CharTraits<UNICHAR>::ToUpper(CharType ch) { return ::towupper(ch); }
template <> FUN_ALWAYS_INLINE CharTraits<UNICHAR>::CharType CharTraits<UNICHAR>::ToLower(CharType ch) { return ::towlower(ch); }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsUpper(CharType ch) { return ::iswupper(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsLower(CharType ch) { return ::iswlower(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsAlpha(CharType ch) { return ::iswalpha(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsPunct(CharType ch) { return ::iswpunct(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsAlnum(CharType ch) { return ::iswalnum(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsDigit(CharType ch) { return ::iswdigit(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsHexDigit(CharType ch) { return ::iswxdigit(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<UNICHAR>::IsWhitespace(CharType ch) { return ::iswspace(ch) != 0; }
...
template <> FUN_ALWAYS_INLINE CharTraits<char>::CharType CharTraits<char>::ToUpper(CharType ch) { return ::toupper(ch); }
template <> FUN_ALWAYS_INLINE CharTraits<char>::CharType CharTraits<char>::ToLower(CharType ch) { return ::tolower(ch); }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsUpper(CharType ch) { return ::isupper(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsLower(CharType ch) { return ::islower(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsAlpha(CharType ch) { return ::isalpha(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsPunct(CharType ch) { return ::ispunct(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsAlnum(CharType ch) { return ::isalnum(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsDigit(CharType ch) { return ::isdigit(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsHexDigit(CharType ch) { return ::isxdigit(ch) != 0; }
template <> FUN_ALWAYS_INLINE bool CharTraits<char>::IsWhitespace(CharType ch) { return ::isspace(ch) != 0; }
