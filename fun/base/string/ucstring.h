...
FUN_BASE_API UNICHAR* ucscpy(UNICHAR* __restrict dst,
                             const UNICHAR* __restrict src);
FUN_BASE_API UNICHAR* ucsncpy(UNICHAR* __restrict dst,
                              const UNICHAR* __restrict src, size_t n);

FUN_BASE_API UNICHAR* ucscat(UNICHAR* __restrict dst,
                             const UNICHAR* __restrict src);
FUN_BASE_API UNICHAR* ucsncat(UNICHAR* __restrict dst,
                              const UNICHAR* __restrict src, size_t n);
...
FUN_BASE_API UNICHAR* ucsstr(const UNICHAR* __restrict str,
                             const UNICHAR* __restrict sub);
FUN_BASE_API UNICHAR* ucsrstr(const UNICHAR* __restrict str,
                              const UNICHAR* __restrict sub);
FUN_BASE_API UNICHAR* ucsistr(const UNICHAR* __restrict str,
                              const UNICHAR* __restrict sub);
FUN_BASE_API UNICHAR* ucsristr(const UNICHAR* __restrict str,
                               const UNICHAR* __restrict sub);

FUN_BASE_API UNICHAR* ucstok(UNICHAR* __restrict str,
                             const UNICHAR* __restrict delim,
                             UNICHAR** __restrict last);
FUN_BASE_API UNICHAR* ucsitok(UNICHAR* __restrict str,
                              const UNICHAR* __restrict delim,
                              UNICHAR** __restrict last);
...
FUN_BASE_API UNICHAR* umemcpy(UNICHAR* __restrict dst,
                              const UNICHAR* __restrict src, size_t n);
