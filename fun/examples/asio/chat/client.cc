...
class ChatClient : Noncopyable {
 public:
  ChatClient(EventLoop* loop, const InetAddress& server_addr)
    ...
    tcp_client_.SetConnectionCallback(boost::bind(&ChatClient::OnConnection, this, _1));
    tcp_client_.SetMessageCallback(boost::bind(&LengthHeaderCodec::OnMessage, &codec_, _1, _2, _3));
