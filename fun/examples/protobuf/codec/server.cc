...
class QueryServer : Noncopyable
{
 public:
  ...
  {
    dispatcher_.RegisterMessageCallback<fun::Query>(boost::bind(&QueryServer::OnQuery, this, _1, _2, _3));
    dispatcher_.RegisterMessageCallback<fun::Answer>(boost::bind(&QueryServer::OnAnswer, this, _1, _2, _3));
 ...
 private:
  ...
  void OnQuery(const fun::net::TcpConnectionPtr& conn,
