...
SimpleStringBuilder::SimpleStringBuilder()
  : string_()
  , reply_ready_(false)
{
}
...
bool SimpleStringBuilder::ReplyReady() const
{
  return reply_ready_;
}

Reply SimpleStringBuilder::GetReply() const
{
  return reply_;
}

const String& SimpleStringBuilder::GetSimpleString() const
{
  return string_;
}
