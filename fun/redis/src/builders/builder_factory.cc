...
UniquePtr<IBuilder> Builders::CreateBuilder(char resp_tag) {
  switch (resp_tag) {
    case '+':
      return UniquePtr<SimpleStringBuilder>(new SimpleStringBuilder);
    case '-':
      return UniquePtr<ErrorBuilder>(new ErrorBuilder);
    case ':':
      return UniquePtr<IntegerBuilder>(new IntegerBuilder);
    case '$':
      return UniquePtr<BulkStringBuilder>(new BulkStringBuilder);
    case '*':
      return UniquePtr<ArrayBuilder>(new ArrayBuilder);
    default:
