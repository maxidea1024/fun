  ...
  , http_cb_(DefaultHttpCallback)
{
  ...
  server_.SetMesageCallback([this](const TcpConnectionPtr& conn, Buffer* buf, const Timestamp& received_time) {
...
void HttpServer::OnMessage(const TcpConnectionPtr& conn, Buffer* buf, const Timestamp& received_time)
{
...
void HttpServer::OnRequest(const TcpConnectionPtr& conn, const http::Request& req)
{
