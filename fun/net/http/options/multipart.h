...
class File {
 public:
  ...
  explicit File(StringType&& file_path) : file_path{FORWARD(file_path)} {}
...
class Part {
 public:
  ...
  Part(const String& name, const std::int32_t& value,
  ...
  Part(const String& name, const Buffer& buffer,
       const String& content_type = {})
      : name{name},
