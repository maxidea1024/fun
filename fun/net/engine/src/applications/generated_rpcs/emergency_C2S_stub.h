...
namespace C2S
{
  struct Stub : public fun::RpcStub
  {
    ...
    #define DECLARE_RPCSTUB_C2S_EmergencyLogData_Error bool EmergencyLogData_Error(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 msg_size_error_count, const fun::int32 net_reset_error_count, const fun::int32 conn_reset_error_count, const fun::int32 last_error_completion_length) override;
    #define IMPLEMENT_RPCSTUB_C2S_EmergencyLogData_Error(TClass) bool TClass::EmergencyLogData_Error(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 msg_size_error_count, const fun::int32 net_reset_error_count, const fun::int32 conn_reset_error_count, const fun::int32 last_error_completion_length)
    ...
    #define DECLARE_RPCSTUB_C2S_EmergencyLogData_Stats bool EmergencyLogData_Stats(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int64 total_tcp_recv_bytes, const fun::int64 total_tcp_send_bytes, const fun::int64 total_udp_send_count, const fun::int64 total_udp_send_bytes, const fun::int64 total_udp_recv_count, const fun::int64 total_udp_recv_bytes) override;
    #define IMPLEMENT_RPCSTUB_C2S_EmergencyLogData_Stats(TClass) bool TClass::EmergencyLogData_Stats(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int64 total_tcp_recv_bytes, const fun::int64 total_tcp_send_bytes, const fun::int64 total_udp_send_count, const fun::int64 total_udp_send_bytes, const fun::int64 total_udp_recv_count, const fun::int64 total_udp_recv_bytes)
    ...
    #define DECLARE_RPCSTUB_C2S_EmergencyLogData_OSVersion bool EmergencyLogData_OSVersion(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::uint32 os_major_version, const fun::uint32 os_minor_version, const fun::uint8 product_type, const fun::uint16 processor_architecture) override;
    #define IMPLEMENT_RPCSTUB_C2S_EmergencyLogData_OSVersion(TClass) bool TClass::EmergencyLogData_OSVersion(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::uint32 os_major_version, const fun::uint32 os_minor_version, const fun::uint8 product_type, const fun::uint16 processor_architecture)
    ...
    #define DECLARE_RPCSTUB_C2S_EmergencyLogData_LogEvent bool EmergencyLogData_LogEvent(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::LogCategory& Category, const fun::DateTime& added_time, const fun::String& text) override;
    #define IMPLEMENT_RPCSTUB_C2S_EmergencyLogData_LogEvent(TClass) bool TClass::EmergencyLogData_LogEvent(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::LogCategory& Category, const fun::DateTime& added_time, const fun::String& text)
    ...
    #define DECLARE_RPCSTUB_C2S_EmergencyLogData_End bool EmergencyLogData_End(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 server_udp_addr_count, const fun::int32 remote_udp_addr_count) override;
    #define IMPLEMENT_RPCSTUB_C2S_EmergencyLogData_End(TClass) bool TClass::EmergencyLogData_End(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 server_udp_addr_count, const fun::int32 remote_udp_addr_count)
