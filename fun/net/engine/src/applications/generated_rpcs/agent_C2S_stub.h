...
namespace C2S
{
  struct Stub : public fun::RpcStub
  {
    ...
    #define DECLARE_RPCSTUB_C2S_RequestCredential bool RequestCredential(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 Cookie) override;
    #define IMPLEMENT_RPCSTUB_C2S_RequestCredential(TClass) bool TClass::RequestCredential(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::int32 Cookie)
    ...
    #define DECLARE_RPCSTUB_C2S_ReportStatusBegin bool ReportStatusBegin(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::uint8 Type, const fun::String& text) override;
    #define IMPLEMENT_RPCSTUB_C2S_ReportStatusBegin(TClass) bool TClass::ReportStatusBegin(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::uint8 Type, const fun::String& text)
    ...
    #define DECLARE_RPCSTUB_C2S_ReportStatusValue bool ReportStatusValue(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::String& Key, const fun::String& Value) override;
    #define IMPLEMENT_RPCSTUB_C2S_ReportStatusValue(TClass) bool TClass::ReportStatusValue(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::String& Key, const fun::String& Value)
    ...
    #define DECLARE_RPCSTUB_C2S_ReportStatusEnd bool ReportStatusEnd(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_C2S_ReportStatusEnd(TClass) bool TClass::ReportStatusEnd(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
    ...
    #define DECLARE_RPCSTUB_C2S_ReportServerAppState bool ReportServerAppState(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const float CpuUserTime, const float CpuKerenlTime, const fun::int32 MemorySize) override;
    #define IMPLEMENT_RPCSTUB_C2S_ReportServerAppState(TClass) bool TClass::ReportServerAppState(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const float CpuUserTime, const float CpuKerenlTime, const fun::int32 MemorySize)
    ...
    #define DECLARE_RPCSTUB_C2S_EventLog bool EventLog(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::LogCategory& Category, const fun::String& text) override;
    #define IMPLEMENT_RPCSTUB_C2S_EventLog(TClass) bool TClass::EventLog(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::LogCategory& Category, const fun::String& text)
