...
namespace C2S
{
  struct Stub : public fun::RpcStub
  {
    ...
    #define DECLARE_RPCSTUB_C2S_Start bool Start(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_C2S_Start(TClass) bool TClass::Start(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
    ...
    #define DECLARE_RPCSTUB_C2S_Chunk bool Chunk(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ByteArray& Chunk) override;
    #define IMPLEMENT_RPCSTUB_C2S_Chunk(TClass) bool TClass::Chunk(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ByteArray& Chunk)
    ...
    #define DECLARE_RPCSTUB_C2S_End bool End(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_C2S_End(TClass) bool TClass::End(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
