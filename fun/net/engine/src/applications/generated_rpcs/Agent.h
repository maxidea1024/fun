...
#define IDL_END_GLOBAL_NAMESPACE namespace fun { namespace Agent {
...
namespace C2S
{
  struct CC2S_RequestCredential_Args
  {
    // arguments.
    fun::int32 Cookie;

    // Construction
    inline CC2S_RequestCredential_Args() {}
  ...
  struct CC2S_RequestCredential_PArgs
  {
    // arguments.
    const fun::int32* Cookie;

    // Construction
    inline CC2S_RequestCredential_PArgs(const fun::int32* Cookie_)
      : Cookie(Cookie_)
    {}
  ...
  struct CC2S_ReportStatusBegin_Args
  {
    // arguments.
    fun::uint8 Type;
    fun::String text;
    ...
    // Construction
    inline CC2S_ReportStatusBegin_Args() {}
  ...
  struct CC2S_ReportStatusBegin_PArgs
  {
    // arguments.
    ...
    // Construction
    inline CC2S_ReportStatusBegin_PArgs(const fun::uint8* Type_, const fun::String* Text_)
      : Type(Type_)
      , text(Text_)
    {}
  ...
  struct CC2S_ReportStatusValue_Args
  {
    // arguments.
    fun::String Key;
    fun::String Value;
    ...
    // Construction
    inline CC2S_ReportStatusValue_Args() {}
  ...
  struct CC2S_ReportStatusValue_PArgs
  {
    // arguments.
    ...
    // Construction
    inline CC2S_ReportStatusValue_PArgs(const fun::String* Key_, const fun::String* Value_)
      : Key(Key_)
      , Value(Value_)
    {}
  ...
  struct CC2S_ReportServerAppState_Args
  {
    // arguments.
    float CpuUserTime;
    float CpuKerenlTime;
    ...
    // Construction
    inline CC2S_ReportServerAppState_Args() {}
  ...
  struct CC2S_ReportServerAppState_PArgs
  {
    // arguments.
    ...
    // Construction
    inline CC2S_ReportServerAppState_PArgs(const float* CpuUserTime_, const float* CpuKerenlTime_, const fun::int32* MemorySize_)
  ...
  struct CC2S_EventLog_PArgs
  {
    ...
    // Construction
    inline CC2S_EventLog_PArgs(const fun::LogCategory* Category_, const fun::String* Text_)
      : Category(Category_)
      , text(Text_)
    {}
...
namespace S2C
{
  struct CS2C_NotifyCredential_Args
  {
    // arguments.
    bool bAuthentication;

    // Construction
    inline CS2C_NotifyCredential_Args() {}
  ...
  struct CS2C_NotifyCredential_PArgs
  {
    // arguments.
    const bool* bAuthentication;

    // Construction
    inline CS2C_NotifyCredential_PArgs(const bool* bAuthentication_)
