...
namespace VizS2C
{
  struct Stub : public fun::RpcStub
  {
    ...
    #define DECLARE_RPCSTUB_VizS2C_NotifyLoginOk bool NotifyLoginOk(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_VizS2C_NotifyLoginOk(TClass) bool TClass::NotifyLoginOk(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
    ...
    #define DECLARE_RPCSTUB_VizS2C_NotifyLoginFailed bool NotifyLoginFailed(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ResultCode& reason) override;
    #define IMPLEMENT_RPCSTUB_VizS2C_NotifyLoginFailed(TClass) bool TClass::NotifyLoginFailed(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ResultCode& reason)
