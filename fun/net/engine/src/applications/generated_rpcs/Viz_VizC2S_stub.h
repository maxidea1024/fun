...
namespace VizC2S
{
  struct Stub : public fun::RpcStub
  {
    ...
    #define DECLARE_RPCSTUB_VizC2S_RequestLogin bool RequestLogin(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::String& AuthenticationKey, const fun::HostId& VizOwnerId) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_RequestLogin(TClass) bool TClass::RequestLogin(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::String& AuthenticationKey, const fun::HostId& VizOwnerId)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifyCommon_SendRpc bool NotifyCommon_SendRpc(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostIdArray& send_to, const fun::VizMessageSummary& summary) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifyCommon_SendRpc(TClass) bool TClass::NotifyCommon_SendRpc(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostIdArray& send_to, const fun::VizMessageSummary& summary)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifyCommon_ReceiveRpc bool NotifyCommon_ReceiveRpc(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& RecvFrom, const fun::String& rpc_name, const fun::RpcId& rpc_id) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifyCommon_ReceiveRpc(TClass) bool TClass::NotifyCommon_ReceiveRpc(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& RecvFrom, const fun::String& rpc_name, const fun::RpcId& rpc_id)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifyCli_ConnectionState bool NotifyCli_ConnectionState(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ConnectionState& ConnectionState) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifyCli_ConnectionState(TClass) bool TClass::NotifyCli_ConnectionState(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::ConnectionState& ConnectionState)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifyCli_Peers_Clear bool NotifyCli_Peers_Clear(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifyCli_Peers_Clear(TClass) bool TClass::NotifyCli_Peers_Clear(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifyCli_Peers_AddOrEdit bool NotifyCli_Peers_AddOrEdit(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& peer_id) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifyCli_Peers_AddOrEdit(TClass) bool TClass::NotifyCli_Peers_AddOrEdit(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& peer_id)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifySrv_ClientEmpty bool NotifySrv_ClientEmpty(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifySrv_ClientEmpty(TClass) bool TClass::NotifySrv_ClientEmpty(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifySrv_Clients_AddOrEdit bool NotifySrv_Clients_AddOrEdit(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& client_id) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifySrv_Clients_AddOrEdit(TClass) bool TClass::NotifySrv_Clients_AddOrEdit(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& client_id)
    ...
    #define DECLARE_RPCSTUB_VizC2S_NotifySrv_Clients_Remove bool NotifySrv_Clients_Remove(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& client_id) override;
    #define IMPLEMENT_RPCSTUB_VizC2S_NotifySrv_Clients_Remove(TClass) bool TClass::NotifySrv_Clients_Remove(const fun::HostId rpc_recvfrom, const fun::RpcHint& RpcHint, const fun::HostId& client_id)
