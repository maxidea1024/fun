...
namespace VizC2S
{
  struct Proxy : public fun::RpcProxy
  {
    ...
    inline bool RequestLogin(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::String& AuthenticationKey, const fun::HostId& VizOwnerId) { return RequestLogin(&rpc_recvfrom, 1, rpc_call_opt, AuthenticationKey, VizOwnerId); }
    ...
    template <typename Allocator>
    inline bool RequestLogin(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::String& AuthenticationKey, const fun::HostId& VizOwnerId) { return RequestLogin(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, AuthenticationKey, VizOwnerId); }
    ...
    bool RequestLogin(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::String& AuthenticationKey, const fun::HostId& VizOwnerId);
    ...
    inline bool NotifyCommon_SendRpc(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::HostIdArray send_to, const fun::VizMessageSummary summary) { return NotifyCommon_SendRpc(&rpc_recvfrom, 1, rpc_call_opt, send_to, summary); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifyCommon_SendRpc(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::HostIdArray send_to, const fun::VizMessageSummary summary) { return NotifyCommon_SendRpc(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, send_to, summary); }
    ...
    bool NotifyCommon_SendRpc(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::HostIdArray send_to, const fun::VizMessageSummary summary);
    ...
    inline bool NotifyCommon_ReceiveRpc(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& RecvFrom, const fun::String& rpc_name, const fun::RpcId& rpc_id) { return NotifyCommon_ReceiveRpc(&rpc_recvfrom, 1, rpc_call_opt, RecvFrom, rpc_name, rpc_id); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifyCommon_ReceiveRpc(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& RecvFrom, const fun::String& rpc_name, const fun::RpcId& rpc_id) { return NotifyCommon_ReceiveRpc(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, RecvFrom, rpc_name, rpc_id); }
    ...
    bool NotifyCommon_ReceiveRpc(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& RecvFrom, const fun::String& rpc_name, const fun::RpcId& rpc_id);
    ...
    inline bool NotifyCli_ConnectionState(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::ConnectionState& ConnectionState) { return NotifyCli_ConnectionState(&rpc_recvfrom, 1, rpc_call_opt, ConnectionState); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifyCli_ConnectionState(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::ConnectionState& ConnectionState) { return NotifyCli_ConnectionState(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, ConnectionState); }
    ...
    bool NotifyCli_ConnectionState(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::ConnectionState& ConnectionState);
    ...
    inline bool NotifyCli_Peers_Clear(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt) { return NotifyCli_Peers_Clear(&rpc_recvfrom, 1, rpc_call_opt); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifyCli_Peers_Clear(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt) { return NotifyCli_Peers_Clear(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt); }
    ...
    bool NotifyCli_Peers_Clear(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt);
    ...
    inline bool NotifyCli_Peers_AddOrEdit(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& peer_id) { return NotifyCli_Peers_AddOrEdit(&rpc_recvfrom, 1, rpc_call_opt, peer_id); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifyCli_Peers_AddOrEdit(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& peer_id) { return NotifyCli_Peers_AddOrEdit(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, peer_id); }
    ...
    bool NotifyCli_Peers_AddOrEdit(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& peer_id);
    ...
    inline bool NotifySrv_ClientEmpty(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt) { return NotifySrv_ClientEmpty(&rpc_recvfrom, 1, rpc_call_opt); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifySrv_ClientEmpty(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt) { return NotifySrv_ClientEmpty(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt); }
    ...
    bool NotifySrv_ClientEmpty(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt);
    ...
    inline bool NotifySrv_Clients_AddOrEdit(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id) { return NotifySrv_Clients_AddOrEdit(&rpc_recvfrom, 1, rpc_call_opt, client_id); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifySrv_Clients_AddOrEdit(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id) { return NotifySrv_Clients_AddOrEdit(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, client_id); }
    ...
    bool NotifySrv_Clients_AddOrEdit(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id);
    ...
    inline bool NotifySrv_Clients_Remove(fun::HostId rpc_recvfrom, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id) { return NotifySrv_Clients_Remove(&rpc_recvfrom, 1, rpc_call_opt, client_id); }
    template <typename Allocator>
    ...
    template <typename Allocator>
    inline bool NotifySrv_Clients_Remove(const fun::Array<fun::HostId,Allocator>& RpcRemoteIds, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id) { return NotifySrv_Clients_Remove(RpcRemoteIds.ConstData(), RpcRemoteIds.Count(), rpc_call_opt, client_id); }
    ...
    bool NotifySrv_Clients_Remove(const fun::HostId* RpcRemoteIds, fun::int32 RpcRemoteIdCount, const fun::RpcCallOption& rpc_call_opt, const fun::HostId& client_id);
  };
