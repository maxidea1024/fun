  ...
  inline SendOption(const RpcCallOption& rpc_call_opt)
      : Reliability(rpc_call_opt.reliability),
        unrealiable_s2c_routed_multicast_max_count(
            rpc_call_opt.unrealiable_s2c_routed_multicast_max_count),
        unreliable_s2c_routed_multicast_max_ping(
            rpc_call_opt.unreliable_s2c_routed_multicast_max_ping),
...
class NetCoreImpl : public RpcHost {
 protected:
  ...
  bool Send_SecureLayer(const SendFragRefs& payload, const SendOption& send_opt,
 ...
 public:
  ...
  virtual bool GetExpectedDecryptCount(HostId remote,
                                       CryptoCountType& out_count) = 0;
   ...
   */
  bool DecryptMessage(MessageType msg_type, ReceivedMessage& received_msg,
   ...
   */
  bool DecompressMessage(ReceivedMessage& received_msg,
...
//@todo 한곳으로 모으는게 좋을듯 싶은데.. 아니면, 글로벌 로컬라이징 기능을
//지원하는게 좋을듯 함! extern const char* DuplicatedRpcIdErrorText; extern
// const char* BadRpcIdErrorText; extern const char*
// AsyncCallbackMayOccurErrorText;
