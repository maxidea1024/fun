...
class RpcCallOption {
 public:
  ...
  /** While this value is false if there are 2 or more received_msg receivers then excludes the messaging to itself(loopback). Default is true. */
  bool bounce;
   ...
   */
  RpcCallOption(MessagePriority priority,
                MessageReliability reliability,
                int32 unrealiable_s2c_routed_multicast_max_count,
                EncryptionMode encryption_mode);
...
inline RpcCallOption::RpcCallOption()
  ...
  , max_direct_p2p_multicast_count(NetConfig::default_max_direct_p2p_multicast_count)
  , unique_id(0)
...
inline RpcCallOption::RpcCallOption(MessagePriority priority,
                                    MessageReliability reliability,
                                    int32 unrealiable_s2c_routed_multicast_max_count,
                                    EncryptionMode encryption_mode)
  : priority(priority)
  ...
  , bounce(true)
  , enable_p2p_jit_trigger(true)
  , unrealiable_s2c_routed_multicast_max_count(unrealiable_s2c_routed_multicast_max_count)
  , unreliable_s2c_routed_multicast_max_ping(NetConfig::unreliable_s2c_routed_multicast_max_ping_default)
  , max_direct_p2p_multicast_count(NetConfig::default_max_direct_p2p_multicast_count)
  , unique_id(0)
  , allow_relayed_send(true)
