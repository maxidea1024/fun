...
class RpcHint {
 public:
  ...
  RpcHint(bool relayed, void* host_tag, int32 result_code = 0,
...
inline RpcHint::RpcHint()
    : relayed(true), host_tag(nullptr), result_code(0), error_message() {}

inline RpcHint::RpcHint(bool relayed, void* host_tag, int32 result_code,
...
inline bool RpcHint::Ok() const { return result_code == 0; }
